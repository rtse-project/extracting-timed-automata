 ...
 */
public class HeavyParsing  extends AbstractLifecycleComponent<Discovery> implements Discovery{
    ...
    public void pubdslish(LocalDiscovery[] members, ClusterChangedEvent clusterChangedEvent, final BlockingClusterStatePublishResponseHandler publishResponseHandler) {
